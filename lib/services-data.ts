...
export const serviceDetails: ServiceDetail[] = [
  {
    ...
    metaDescription: "Loc maintenance, retwist, and interlocking in Berkeley with Britnee Lott at Studio Salon on Sacramento St. Call (510) 690-5274 to book.",
    h1: "Loc Maintenance and Retwist in Berkeley",
    intro: "Locs are a long relationship, not a one-time appointment. At Studio Salon on Sacramento St, we treat every head of locs like the ongoing project it is — tracking how your grid is settling in, where roots are loosening, and how the ends are behaving. Britnee has been specializing in locs for years, and the chair is set up for real loc work: palm rolling, interlocking, repair on thinning spots, and clean retwists that actually hold. Whether you are two months into a starter set or ten years into a mature crown, we match the maintenance to the stage of your hair. Most clients book every four to six weeks, and we talk through your home routine every visit so the work holds between appointments. Starts at $85 and runs about 85 to 95 minutes in the chair.",
    sections: [
      {
  ...
  },
  {
    ...
    intro: "Men's hair at Studio Salon covers the full range — braids, buzz cuts, line-ups, and more involved cuts with shape and texture. Britnee handles men's braids as a specialty alongside the rest of her braid work, which means cornrows, feed-ins, and tribal styles are all on the menu for male clients too. Pricing runs $100 to $150 depending on the service, and appointments take 70 to 195 minutes. The chair welcomes teens and adults, and we are comfortable with every texture from fine and wavy to dense 4c coils. If you have been looking for a Berkeley chair that can handle a clean line-up and a full braid set in the same place, this is it. Call (510) 690-5274 or stop by 2902 Sacramento St.",
    sections: [
      {
      ...
      },
      {
        ...
        content: "Most men's hair in Berkeley lives at traditional barbershops, which are great for cuts but not always equipped for braid work or for certain textures. Studio Salon bridges that gap: you get a chair that can deliver a clean line-up and a full knotless set without having to make two separate appointments at two separate shops. Britnee braids men's hair at the same quality she braids women's — low tension, clean parts, tight install. Cuts get the same care. The salon is an easy stop at 2902 Sacramento St with usually manageable parking on the block. If you have been making do with two stops for your hair routine, consolidating at one chair that can handle both sides is a real quality-of-life upgrade. Call (510) 690-5274 to get on the schedule."
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Cutting textured hair is a specific skill, and not every chair has it. Britnee's background in natural hair, locs, and braid work means she reads texture before she picks up scissors — which sounds obvious but makes a real difference in how the finished cut behaves over the days and weeks after the appointment. We cut shapes that work at home, not just shapes that look good in the salon mirror under the right lighting. We are honest about what a cut will and will not fix; if your shape problem is really a style problem or a product problem, we will say so. Studio Salon serves Berkeley and the East Bay from 2902 Sacramento St, and we are happy to book a consult before a first cut if you want to talk through shape options. Call (510) 690-5274."
      },
    ],
