...
export const locationDetails: LocationDetail[] = [
  /* ── Berkeley ────────────────────────────────────────────── */
  {
    ...
    metaDescription:
      "Studio Salon on 2902 Sacramento St in Berkeley. Locs, natural hair, braids, color, and men's cuts. Book: (510) 690-5274.",
    h1: "Berkeley Hair Salon and Loc Specialist on Sacramento St",
    intro:
      "Studio Salon sits at 2902 Sacramento St in Berkeley, right on the Berkeley-Oakland line where South Berkeley meets North Oakland. If you live in the Gourmet Ghetto, walk over from the Elmwood on a Saturday morning, or drive in from Claremont or the hills above campus, getting here is easy — and worth it. Studio Salon Berkeley has built its chair around the people who actually live in this city: students running between classes at UC Berkeley, longtime West Berkeley families, and folks who have been growing their locs with us for years. Come in for a consultation and see why locals keep coming back.",
    sections: [
      {
        heading: "Why Berkeley Locals Choose Us",
        content:
          "Studio Salon Berkeley opened because the city deserved a stylist who treats every head of hair like it matters — not a chain that rushes you out the door. Our chair at 2902 Sacramento St is where locs get started, retwisted, styled, and repaired. Natural hair gets washed, conditioned, and detangled with care. Braids, weaves, and color are done with the patience real hair requires. Men's cuts are clean, quick, and on time. Berkeley clients come in with specific needs: a grad student who wants interlocked starter locs before a conference, a West Berkeley mom who brings her daughter in for the first real braid-down of the school year, a Claremont professor who has been getting cuts here for a decade. The common thread is trust. You book with Studio Salon Berkeley once, you understand. Call (510) 690-5274 to talk through what you want before your first visit.",
      },
      {
  ...
  /* ── Oakland ─────────────────────────────────────────────── */
  {
    ...
    metaDescription:
      "Oakland hair salon specializing in locs, natural hair, braids, color, and men's cuts. Studio Salon Berkeley at 2902 Sacramento St. Call (510) 690-5274.",
    h1: "Oakland Hair Salon for Locs, Natural Hair, and Cuts",
    intro:
      "From Rockridge to Fruitvale, Oakland clients have been making the short trip to Studio Salon at 2902 Sacramento St in Berkeley for years. We sit just over the Berkeley-Oakland line, about a mile from Temescal and an easy run up San Pablo or Telegraph from anywhere in North Oakland. Studio Salon Berkeley does locs, natural hair, braids, weaves, color, and men's cuts — the services Oakland clients have told us they cannot reliably find without driving across the bridge or waiting weeks for a chair. If you are in Oakland and you want a stylist who listens, call (510) 690-5274.",
    sections: [
      {
        heading: "Why Oakland Clients Keep Coming Back",
        content:
          "Studio Salon Berkeley was built for the kind of client Oakland is full of — people who want real hair care, done well, without being pushed toward services they did not ask for. Our specialty is locs: starting them, retwisting, interlocking, repairing damage from previous stylists, and styling for weddings, graduations, and everyday life. We also do natural hair from wash and condition to silk press, braids and weaves that lay right and hold, color that actually lifts without frying the hair underneath, and men's cuts that come out clean and even. Oakland clients come from Rockridge for precision work, from Fruitvale and West Oakland because they have heard about us from family and friends, and from Uptown and Lake Merritt because we are close enough to hit on a lunch break. The common thread is the consultation. We talk first, cut or twist second.",
      },
      {
  ...
  /* ── Albany ──────────────────────────────────────────────── */
  {
    ...
    metaDescription:
      "Studio Salon is a short drive down San Pablo from Albany. Locs, natural hair, braids, color, and men's cuts. (510) 690-5274.",
    h1: "Albany Hair Salon and Loc Specialist Nearby",
    intro:
      "Albany is about a ten-minute drive south on San Pablo Ave to Studio Salon at 2902 Sacramento St in Berkeley. If you live off Solano, up near Albany Hill, or anywhere along the San Pablo corridor, you have probably already passed the salon on a grocery run. Studio Salon Berkeley works with a lot of Albany clients — parents, teachers, Albany High and St. Mary's families, and neighbors who found us through word of mouth. Services run the full range: locs from start to finish, natural hair, braids, weaves, color, and men's cuts. Call (510) 690-5274 to get on the books.",
    sections: [
      {
        heading: "Why Albany Chooses Studio Salon",
        content:
          "Albany is a small city, and word about a good stylist travels fast on Solano Ave. Studio Salon Berkeley has become one of the names people mention when an Albany client asks around for a loc specialist or a natural hair stylist who knows the work. The services we offer cover everything Albany clients typically ask for: starter locs, retwists, interlocking, loc repair, natural hair wash and style, braids, weaves, color, and men's cuts that actually fade clean. What separates the chair at Studio Salon from the options closer to Solano is the consultation. We will tell you what is realistic with your hair, what is going to take time, and what is going to cost you more than it is worth. We would rather lose an appointment than send you home with something we know is not going to hold. That honesty is what Albany clients come back for.",
      },
      {
      ...
      },
      {
        ...
        content:
          "First-visit bookings from Albany are simple. Call or text (510) 690-5274, or book through the site, and we will confirm the service you are after and give you a realistic time estimate. Loc appointments tend to run longer; cuts and simple retwists are quicker. When you get to the salon, plan on fifteen minutes at the start to sit down, talk through your goals, and let us actually look at your hair before we start. If you are transitioning — from braids, from relaxed hair, from locs that were started somewhere else — this conversation is where you get straight answers about the timeline. Bring reference photos if you have a specific style in mind. Do not worry about washing beforehand unless you have been asked to. The salon is at 2902 Sacramento St, Berkeley, CA 94702. Parking is usually on the street, and the vibe inside is unhurried.",
      },
    ],
    neighborhoods: [
      "Solano Ave",
  ...
  /* ── Emeryville ──────────────────────────────────────────── */
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "If you are coming in from Emeryville for the first time, book by calling (510) 690-5274 or using the online booking link. We will confirm the service, ballpark the timing, and let you know what to bring. For locs, that might mean coming in with your hair in a specific state depending on whether we are starting, retwisting, or repairing. For color, we will usually ask about your most recent color history so we can plan the lift without surprises. Braids, weaves, and men's cuts are more straightforward. When you get to Studio Salon, expect a real consultation before anything starts — we will look at your hair, ask a few questions, and lay out the plan. The address is 2902 Sacramento St, Berkeley, CA 94702. Parking is usually on Sacramento itself or a side street. First-time clients almost always leave with a rebook and a clear plan for what comes next.",
      },
    ],
    neighborhoods: [
      "Bay Street",
  ...
  /* ── El Cerrito ──────────────────────────────────────────── */
  {
    ...
    metaDescription:
      "From El Cerrito to Studio Salon at 2902 Sacramento St, Berkeley. Locs, natural hair, braids, color, and men's cuts. (510) 690-5274.",
    h1: "El Cerrito Hair Salon and Loc Specialist",
    intro:
      "El Cerrito is an easy run down San Pablo Ave to Studio Salon at 2902 Sacramento St, Berkeley. From El Cerrito Plaza, it is about fifteen minutes in light traffic — and El Cerrito Plaza BART puts you on a direct line to Ashby BART, which is the closest stop to the salon. Studio Salon Berkeley has a strong client base from El Cerrito: Del Norte regulars, Hillside families, Richmond Annex neighbors, and folks who have been coming since they lived closer and just kept their appointments when they moved north. Services cover locs, natural hair, braids, weaves, color, and men's cuts. (510) 690-5274.",
    sections: [
      {
        heading: "Why El Cerrito Picks Studio Salon",
        content:
          "El Cerrito clients tend to know what they want when they walk in — they have usually done their research, asked around, and decided they are willing to make the short trip down San Pablo for the right stylist. Studio Salon Berkeley earns that trust by doing exactly what we say we will do. Services at Studio Salon cover the full range of what El Cerrito clients typically book: starter locs, retwists, interlocking, loc repair, natural hair wash and style, silk press, braids, weaves, color, and men's cuts. There is no upselling; if a service is not right for your hair, we will tell you. El Cerrito clients often book recurring appointments — monthly retwists, six-week cuts, quarterly color — because consistency is easier than shopping around. The chair at 2902 Sacramento St has become a regular rhythm for a lot of El Cerrito families.",
      },
      {
      ...
      },
      {
        ...
        content:
          "El Cerrito clients who are booking Studio Salon for the first time should plan the visit like any real appointment — give yourself room on the front end for a consultation. Call or text (510) 690-5274 or book online. We will confirm what you are coming in for and how long to block out. For locs, be ready to talk about your current state — starter, retwist, interlock, repair — and your end goal. For color, natural hair, braids, or weaves, the consult covers condition, past services, and what you want. Men's cuts are handled quickly. Bring reference photos if you have them. When you arrive at 2902 Sacramento St, Berkeley, CA 94702, park on Sacramento or a side street. Walk in, sign in, and we will get started after the consultation. The goal of the first visit is not just the service — it is the relationship, so you leave with a plan.",
      },
    ],
    neighborhoods: [
      "El Cerrito Plaza",
  ...
  /* ── Richmond ────────────────────────────────────────────── */
  {
    ...
    metaDescription:
      "Studio Salon at 2902 Sacramento St serves Richmond, CA. Locs, natural hair, braids, color, and men's cuts. (510) 690-5274.",
    h1: "Richmond Hair Salon — Locs, Natural Hair, Color",
    intro:
      "Richmond clients have been driving down to Studio Salon for years. The run from Point Richmond, Marina Bay, Hilltop, or the San Pablo side of Richmond to 2902 Sacramento St in Berkeley takes twenty to twenty-five minutes on a normal day — a little longer on Friday afternoons. Studio Salon Berkeley has built a steady Richmond following because there are not many places north of the Bay that handle locs, natural hair, and color the way we do. Services include locs start to finish, natural hair, braids, weaves, color, and men's cuts. If you are in Richmond and looking for a real stylist, call (510) 690-5274.",
    sections: [
      {
        heading: "Why Richmond Clients Make the Drive",
        content:
          "Richmond is a big, spread-out city, and finding a stylist who handles locs and textured hair well is not simple. That is why a meaningful number of Studio Salon Berkeley's clients come down from Richmond every month. The services we offer — starter locs, retwists, interlocking, loc repair, natural hair, silk press, braids, weaves, color, and men's cuts — are the services Richmond clients have often told us they have had trouble finding locally. The consultation is what makes the trip worth it. We do not rush. We look at your hair, ask about your last stylist, talk through what has worked and what has failed, and give you an honest take. Richmond clients typically end up booking recurring appointments because the quality is consistent and the drive becomes part of their routine. For many, it is the only real option for the kind of work they want done.",
      },
      {
  ...
  /* ── Kensington ──────────────────────────────────────────── */
  {
    ...
    intro:
      "Kensington sits on the ridge between Berkeley and El Cerrito, and for Kensington residents the drive down to Studio Salon is short — ten minutes off the hill, straight into South Berkeley. Arlington Ave drops south into Berkeley easily, and from Kensington Park the run down Colusa or Arlington is second nature. Studio Salon Berkeley works with a steady group of Kensington clients: long-time homeowners, Kensington Hilltop School families, and residents who have been with us since we opened. Services at Studio Salon cover locs, natural hair, braids, weaves, color, and men's cuts. The salon is at 2902 Sacramento St, Berkeley, CA 94702. Call (510) 690-5274.",
    sections: [
      {
        heading: "Why Kensington Comes Down the Hill",
        content:
          "Kensington is small and close-knit, and the word about a trustworthy stylist moves fast. Studio Salon Berkeley has become one of the local names when Kensington residents ask around for a loc specialist, a natural hair stylist, or a place their teenager can get a real cut. Services run across the board: starter locs, retwists, interlocking, loc repair, natural hair, silk press, braids, weaves, color, and men's cuts. Kensington clients tend to value honesty over hype — they want to know what is going to work and what is not, how often they should be coming in, and how to care for their hair between visits. That is exactly how we run the chair. The consultation is not a formality; it is the foundation of the appointment. After a first visit, most Kensington clients book their next appointment before they leave, because the short drive is worth it.",
      },
      {
      ...
      },
      {
        ...
        content:
          "First-time Kensington clients usually find the salon easy to get to and easy to work with. Call or text (510) 690-5274, or book online. We will confirm what service you are scheduling and how much time to block off. Locs tend to take the longest — especially a first retwist or a repair session — so be ready for a longer appointment on your first visit. Color, braids, weaves, and natural hair require a real consultation up front; we will look at your hair, ask about recent services, and talk through what you want. Men's cuts are quicker. Bring reference photos if there is a specific look in mind. The salon is at 2902 Sacramento St, Berkeley, CA 94702. Park on Sacramento or the side streets. The first visit is as much about building the working relationship as it is about the hair itself — you leave with a plan.",
      },
    ],
    neighborhoods: [
      "Arlington Ave",
